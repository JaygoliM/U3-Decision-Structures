...
public class ShippingCosts {
    ...
    public static void main(String[] args) {
        double itemWeight = Double.parseDouble(JOptionPane.showInputDialog("Whats tge weight?"));
        int milesShipped = Integer.parseInt(JOptionPane.showInputDialog("How many miles did it take to ship"));
    ...
    public static double cost(double rate, double miles){

        int costMultiplier = (int) (miles/100);
